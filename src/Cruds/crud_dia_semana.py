...
def inserir_dia(values):
    ...
    try:
        ...
        query = f'''
            INSERT INTO dia_semana(id_turma,dia_semana)
...
def crud_remove_dia(id,dia):
    ...
    try:
        ...
        query = f'''
            ...
            WHERE
                id_turma = {id} and dia_semana = {dia};
                '''
        cursor = conn.cursor()
        cursor.execute(query)
        conn.commit()
